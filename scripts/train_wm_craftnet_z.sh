#!/usr/bin/env bash
# WM-Craftnet z-axis training entry.
# This script intentionally keeps overrides minimal.
# Usage:
#   1) Edit only device switches below.
#   2) Run: ./scripts/train_wm_craftnet_z.sh [optional hydra args...]
set -euo pipefail
...
# NUM_ENVS=1024 MINIBATCH_SIZE=4096 bash scripts/train_wm_craftnet_z.sh
